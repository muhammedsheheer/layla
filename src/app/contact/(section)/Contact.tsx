  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
                ...
                <div className="flex flex-col gap-4">
                  <Link href={"https://g.co/kgs/KBMNsyS"} target="_blank">
                    <p className="font-poppins text-[#9C9E9F]">
                      453 Warrington Rd, Culcheth, <br /> Warrington WA3 5SJ,
                      United Kingdom
                    </p>
                  </Link>
                  <Link href={"https://g.co/kgs/KBMNsyS"} target="_blank">
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2375.8959411458345!2d-2.519845023405543!3d53.45244637232024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487b078827817c17%3A0xaa7011be60d7c5de!2sIstanbul%20Grill%20Culcheth!5e0!3m2!1sen!2sin!4v1746884423158!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
